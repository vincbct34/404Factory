...
const services = [
  {
    ...
    description: "Développement web moderne avec les dernières technologies. React, Next.js, Node.js.",
    command: "> npm run build-website",
  },
  {
    icon: Zap,
    title: "AUTOMATISATIONS",
    description: "Scripts personnalisés, APIs, intégrations. Automatisez vos processus métier.",
    command: "> python automate.py",
  },
  {
    icon: Terminal,
    title: "CONSULTING_TECH",
    description: "Audit technique, architecture, optimisation. Expertise à votre service.",
            ...
            >
              <div className="flex items-start gap-4 mb-4">
                ...
                <div>
                  ...
                  <div className="text-sm font-mono text-gray-500 mb-4">{service.command}</div>
            ...
            <div className="group border border-gray-800 hover:border-electric-blue/50 transition-all duration-300 p-8 bg-gray-900/20 hover:bg-gray-900/40">
              <div className="flex items-start gap-4 mb-4">
                {(() => {
                  ...
                  return <IconComponent className="w-8 h-8 text-electric-blue flex-shrink-0 mt-1" />;
                })()}
                <div>
                  <h3 className="text-2xl font-bold mb-2 group-hover:text-electric-blue transition-colors">
                    {services[2].title}
                  </h3>
                  <div className="text-sm font-mono text-gray-500 mb-4">{services[2].command}</div>
                  <p className="text-gray-300 leading-relaxed">{services[2].description}</p>
                </div>
              </div>
            </div>
          </div>
