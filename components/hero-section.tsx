...
export function HeroSection() {
  ...
  return (
    ...
    >
      ...
      {/* Glitch overlay */}
      <div
        className={`absolute inset-0 bg-electric-blue/5 transition-opacity duration-100 ${
      ...
      <div className="text-center z-10 max-w-6xl mx-auto px-6">
        ...
        <div className="mb-8">
          <div className="text-8xl md:text-9xl font-black text-electric-blue/20 select-none">
            404
          </div>
          <div className="text-sm uppercase tracking-[0.3em] text-gray-400 -mt-4">
            ERROR_NOT_FOUND
          </div>
        </div>
        ...
        <p className="text-xl md:text-2xl text-gray-300 mb-12 max-w-3xl mx-auto font-light">
          ...
          <br />
          Imaginez, créez et transformez vos idées en réalité grâce à mon
          expertise.
        </p>
      ...
      {/* Floating elements */}
      <div className="absolute top-20 left-10 text-electric-blue/30 font-mono text-sm animate-pulse">
        {"<html>"}
      </div>
